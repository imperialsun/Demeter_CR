...
FROM node:26.8.2-alpine3.23 AS builder
WORKDIR /app
...
RUN apk upgrade --no-cache c-ares zlib libexpat libpng libxpm libcurl xz-libs nghttp2-libs libcrypto3 libssl3 libuuid
