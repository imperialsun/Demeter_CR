...
export function ReportDetailLevelsSection({
  ...
  description = "Les formats CRI, CRO, CRS et CRN restent inchanges. Les curseurs ajustent uniquement le niveau de detail du resultat. Si des interlocuteurs sont nommes, leurs noms et leur avis ou position sont cites.",
  className,
  disabled = false,
