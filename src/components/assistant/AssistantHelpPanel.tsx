...
const ASSISTANT_HELP_SECTIONS: AssistantHelpSectionConfig[] = [
  ...
  },
  {
    ...
    summary: "Télécharger la transcription et les versions finales.",
    points: [
      "Téléchargez la transcription DOCX pour récupérer le texte final avec les bons noms.",
      "Réglez le niveau de détail des CRI, CRO, CRS et CRN avec les curseurs avant la génération.",
      "Si des interlocuteurs sont nommés, leurs noms et leur avis ou position sont cités dans les comptes rendus.",
      `Téléchargez ${buildReportFormatLabel("CRI")}, ${buildReportFormatLabel("CRO")}, ${buildReportFormatLabel("CRS")} et ${buildReportFormatLabel("CRN")} quand les boutons sont visibles.`,
