...
const TELEMETRY_PREVIEW_SUMMARY: TelemetrySummary = {
  ...
  events: [
    ...
    { type: "LLM_RUN_STAGE", timestamp: 2670, data: { provider: "local", stage: "format_generation_start" } },
    { type: "LLM_RUN_STAGE", timestamp: 2830, data: { provider: "huggingface", stage: "run_done" } },
