...
vi.mock('@/lib/preprocessing', async () => {
  ...
  return {
    ...actual,
    estimateNoiseProfile: vi.fn(() => {
      calibrated = true;
      return { profile: new Float32Array(513), frames: 10 };
    }),
    ...
    computePreprocessParams: vi.fn(() => ({ noiseFloorDb: -25, reductionDb: 10, smoothing: 0.8, snrDb: 20 })),
  };
});
